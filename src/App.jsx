  ...
  return (
    <div style={{ borderRight: vi < totalVariants - 1 ? `1px solid ${T.lightGrey}` : "none", padding: vi === 0 ? "0 24px 0 0" : vi === totalVariants - 1 ? "0 0 0 24px" : "0 24px" }}>
      ...
      <button onClick={() => onSelectVariant(v)}
        style={{ width: "100%", padding: "13px 16px", background: T.black, color: T.white, border: "none", borderRadius: 8, fontSize: 14, fontWeight: 570, cursor: "pointer", fontFamily: T.fontB, display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, transition: "opacity 0.15s" }}
