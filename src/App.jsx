...
const BIKES = [
  { id: "xr-9-7-gf", family: "XR 9.7 GF", category: "Gran Fondo", variants: [
    { id: "xr-9-7-gf-26", name: "XR 9.7 GF", subtitle: "DT Swiss Carbon Wheels, Shimano Ultegra Di2",
      price: 144990, salePrice: null, colors: ["#111"], img: IMG_XR97_NEW,
      weight:"7.95 kg", frame:"SU-51-01, Carbon XR Race High Modulus", groupset:"Shimano Ultegra Di2 R8170",
      wheels:"DT Swiss ERC 1600 SPLINE®, Carbon", brakes:"Shimano Ultegra R8170, Hydraulic Disc",
      cockpit:"ONE Race ICR Alloy Stem + ONE Alloy X-Race Aero Handlebar", headset:"ACROS AIX-318R1",
      tires:"Schwalbe Pro One Evo, 30-622", saddle:"Fizi:k Vento Argo R5",
      cassette:"Shimano Ultegra CS-R8101, 11-34", sizes:["XS","S","M","L","XL","XXL"] },
    { id: "xr-9-7-gf-25", name: "XR 9.7 GF", subtitle: "DT Swiss Alloy Wheels, Shimano Ultegra Di2",
      price: 129990, salePrice: 99990, colors: ["#4a1520"], img: IMG_XR97_OLD,
      weight:"7.95 kg", frame:"SU-51-01, Carbon XR Race High Modulus", groupset:"Shimano Ultegra Di2 R8170",
      wheels:"DT Swiss ER 1600 SPLINE®, Alloy", brakes:"Shimano Ultegra R8170, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", headset:"ACROS AIX-525R3S",
      tires:"Schwalbe Pro One Evo, 30-622", saddle:"Fizi:k Vento Argo R5",
      cassette:"Shimano Ultegra CS-R8101, 11-34", sizes:["S","M","L","XL"] },
  ]},
  { id: "xr-9-8-gf", family: "XR 9.8 GF", category: "Gran Fondo", variants: [
    { id: "xr-9-8-gf-26", name: "XR 9.8 GF", subtitle: "DT Swiss Aero Wheels, Shimano Ultegra Di2",
      price: 169990, salePrice: 149990, colors: ["#1a1a2e","#cc0000","#d4d4d4"], img: IMG_BIKE_A,
      weight:"7.4 kg", frame:"Carbon XR Race High Modulus", groupset:"Shimano Ultegra Di2 R8170",
      wheels:"DT Swiss ARC 1600 SPLINE®, Carbon", brakes:"Shimano Ultegra R8170, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe Pro One Evo, 30-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["XS","S","M","L","XL"] },
    { id: "xr-9-8-gf-25", name: "XR 9.8 GF", subtitle: "DT Swiss Alloy Wheels, Shimano Ultegra Di2",
      price: 139990, salePrice: null, colors: ["#cc0000"], img: IMG_XR97_OLD,
      weight:"7.5 kg", frame:"Carbon XR Race High Modulus", groupset:"Shimano Ultegra Di2 R8170",
      wheels:"DT Swiss ER 1600 SPLINE®, Alloy", brakes:"Shimano Ultegra R8170, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe Pro One Evo, 30-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["S","M","L","XL"] },
  ]},
  { id: "xr-9-9-gr", family: "XR 9.9 GR", category: "Gravel", variants: [
    { id: "xr-9-9-gr-26", name: "XR 9.9 GR", subtitle: "SRAM Red AXS XPLR, Carbon Wheels",
      price: 194990, salePrice: 174990, colors: ["#1a1a2e","#cc0000","#d4d4d4"], img: IMG_BIKE_B,
      weight:"7.9 kg", frame:"Carbon XR Race High Modulus", groupset:"SRAM Red AXS XPLR",
      wheels:"DT Swiss GRC 1600 SPLINE®, Carbon", brakes:"SRAM Red AXS, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe G-One R, 40-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["S","M","L","XL"] },
    { id: "xr-9-9-gr-25", name: "XR 9.9 GR", subtitle: "SRAM Red AXS XPLR, Alloy Wheels",
      price: 174990, salePrice: 154990, colors: ["#cc0000","#d4d4d4"], img: IMG_BIKE_A,
      weight:"8.0 kg", frame:"Carbon XR Race High Modulus", groupset:"SRAM Red AXS XPLR",
      wheels:"DT Swiss GR 1600 SPLINE®, Alloy", brakes:"SRAM Red AXS, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe G-One R, 40-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["S","M","L","XL","XXL"] },
  ]},
  { id: "xr-9-9-gr-ltd", family: "XR 9.9 GR LTD", category: "Gravel", variants: [
    { id: "xr-9-9-gr-ltd-25", name: "XR 9.9 GR LTD", subtitle: "SRAM Red AXS XPLR, Carbon Wheels",
      price: 216990, salePrice: null, colors: ["#cc0000"], img: IMG_BIKE_B,
      weight:"7.8 kg", frame:"Carbon XR Race High Modulus", groupset:"SRAM Red AXS XPLR",
      wheels:"DT Swiss GRC 1400 SPLINE®, Carbon", brakes:"SRAM Red AXS, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe G-One R, 40-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["S","M","L","XL"] },
    { id: "xr-9-9-gr-ltd-24", name: "XR 9.9 GR LTD", subtitle: "SRAM Force AXS XPLR, Carbon Wheels",
      price: 184990, salePrice: 169990, colors: ["#1a1a2e","#cc0000"], img: IMG_BIKE_A,
      weight:"8.0 kg", frame:"Carbon XR Race High Modulus", groupset:"SRAM Force AXS XPLR",
      wheels:"DT Swiss GRC 1600 SPLINE®, Carbon", brakes:"SRAM Force AXS, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe G-One R, 40-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["S","M","L","XL","XXL"] },
    { id: "xr-9-9-gr-ltd-23", name: "XR 9.9 GR LTD", subtitle: "Shimano Ultegra Di2, Alloy Wheels",
      price: 154990, salePrice: null, colors: ["#d4d4d4"], img: IMG_XR97_NEW,
      weight:"8.3 kg", frame:"Carbon XR Race High Modulus", groupset:"Shimano Ultegra Di2 R8170",
      wheels:"DT Swiss GR 1600 SPLINE®, Alloy", brakes:"Shimano Ultegra R8170, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe G-One R, 40-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["XS","S","M","L","XL"] },
  ]},
  { id: "rr-9-8", family: "RR 9.8", category: "Road", variants: [
    { id: "rr-9-8-25", name: "RR 9.8", subtitle: "Shimano Ultegra Di2, DT Swiss Aero Wheels",
      price: 139990, salePrice: 119990, colors: ["#1a1a2e","#cc0000","#d4d4d4"], img: IMG_BIKE_A,
      weight:"7.6 kg", frame:"Carbon RR Race High Modulus", groupset:"Shimano Ultegra Di2 R8170",
      wheels:"DT Swiss ARC 1600 SPLINE®, Carbon", brakes:"Shimano Ultegra R8170, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe Pro One Evo, 28-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["XS","S","M","L","XL","XXL"] }
  ]},
  { id: "xr-9-8-gr", family: "XR 9.8 GR", category: "Gravel", variants: [
    { id: "xr-9-8-gr-25", name: "XR 9.8 GR", subtitle: "SRAM Force 12 speed",
      price: 159990, salePrice: null, colors: ["#1a1a2e","#cc0000","#d4d4d4"], img: IMG_BIKE_B,
      weight:"8.1 kg", frame:"Carbon XR Race High Modulus", groupset:"SRAM Force AXS XPLR",
      wheels:"DT Swiss GRC 1600 SPLINE®", brakes:"SRAM Force AXS, Hydraulic Disc",
      cockpit:"ONE Carbon Integrated Cockpit ICR", tires:"Schwalbe G-One R, 40-622",
      saddle:"Fizi:k Vento Argo R5", sizes:["S","M","L","XL"] }
  ]},
];
...
function Badge({ label, variant = "dark" }) {
  return (
    <span style={{
      background: variant === "sale" ? T.sale : T.black, color: T.white,
      fontFamily: T.fontM, fontSize: 11, fontWeight: 400,
      padding: "4px 10px", borderRadius: 4, letterSpacing: "0.04em", textTransform: "uppercase",
  ...
  return (
    <button onClick={onClick}
      style={{
        ...
        background: isCompared ? T.black : T.white, color: isCompared ? T.white : T.black,
        border: `1px solid ${T.lightGrey}`, borderRadius: 6, padding: "7px 14px",
        fontSize: 13, fontWeight: 500, cursor: "pointer", display: "flex", alignItems: "center", gap: 6,
        opacity: visible ? 1 : 0, transition: "opacity 0.2s,background 0.15s,color 0.15s",
        fontFamily: T.fontB, lineHeight: 1,
      }}>
...
// ─── Middle Page: Variant Card ──────────────────────────────────────────────

function VariantCompareCard({ v, vi, totalVariants, onSelectVariant, onCompare, isCompared, diffKeys, sameKeys, getVal, passes }) {
  const [h, setH] = useState(false);
  ...
  return (
    <div style={{ borderRight: vi < totalVariants - 1 ? `1px solid ${T.lightGrey}` : "none", padding: vi === 0 ? "0 24px 0 0" : vi === totalVariants - 1 ? "0 0 0 24px" : "0 24px" }}>
      ...
      <div onMouseEnter={() => setH(true)} onMouseLeave={() => setH(false)} onClick={() => onSelectVariant(v)}
        ...
        <CompareButton isCompared={isCompared} visible={h || isCompared}
          onClick={(e) => { e.stopPropagation(); onCompare(v.id); }} />
      </div>

      <div style={{ fontFamily: T.fontH, fontSize: 18, fontWeight: 570, lineHeight: 1, color: T.black, marginBottom: 8 }}>{v.name}</div>
      <div style={{ color: T.darkGrey, fontFamily: T.fontB, fontSize: 14, fontWeight: 570, lineHeight: 1.5, marginBottom: 12 }}>{v.subtitle}</div>
      ...
      <button onClick={() => onSelectVariant(v)}
        style={{ width: "100%", padding: "13px 16px", background: T.black, color: T.white, border: "none", borderRadius: 100, fontSize: 14, fontWeight: 570, cursor: "pointer", fontFamily: T.fontB, display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20, transition: "opacity 0.15s" }}
        onMouseEnter={(e) => e.currentTarget.style.opacity = "0.85"} onMouseLeave={(e) => e.currentTarget.style.opacity = "1"}>
        <span>View detail</span><span>→</span>
      </button>

      <div style={{ display: "flex", gap: 6, marginBottom: 16 }}>{v.colors.map((c, i) => <ColorDot key={i} color={c} />)}</div>
      <div style={{ fontFamily: T.fontB, fontSize: 12, color: T.midGrey, marginBottom: 24 }}>{(v.sizes || []).join(", ")}</div>
      ...
      {diffKeys.length > 0 && (
        <>
          ...
          {diffKeys.map(({ key, label }) => {
            ...
            return (
              <div key={key} style={{ padding: "12px 0", borderBottom: `1px solid ${T.lightGrey}` }}>
                <div style={{ fontFamily: T.fontB, fontSize: 11, fontWeight: 570, color: val ? T.darkGrey : T.midGrey, textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: 4 }}>{label}</div>
                <div style={{ fontFamily: T.fontB, fontSize: 13, fontWeight: 570, color: val ? T.black : T.midGrey, lineHeight: 1.4 }}>{val || "—"}</div>
              </div>
            );
          })}
        </>
      ...
      {sameKeys.length > 0 && (
        <>
          <div style={{ padding: "16px 0 8px" }}>
            <span style={{ fontFamily: T.fontB, fontSize: 11, fontWeight: 570, color: T.midGrey, textTransform: "uppercase", letterSpacing: "0.04em" }}>Identical specs</span>
          </div>
          {sameKeys.map(({ key, label }) => {
            const val = getVal(v, key);
            if (!val) return null;
            return (
              <div key={key} style={{ padding: "10px 0", borderBottom: `1px solid ${T.bgGrey}` }}>
                <div style={{ fontFamily: T.fontB, fontSize: 11, fontWeight: 400, color: T.midGrey, textTransform: "uppercase", letterSpacing: "0.04em", marginBottom: 3 }}>{label}</div>
                <div style={{ fontFamily: T.fontB, fontSize: 13, color: T.darkGrey, lineHeight: 1.4 }}>{val}</div>
              </div>
            );
          })}
        </>
...
function VariantComparePage({ bike, onBack, backLabel, onSelectVariant, compared, onCompare, variantPassesFilter }) {
  ...
  return (
    <div style={{ maxWidth: 1100, margin: "0 auto", padding: "0 32px 80px" }}>
      ...
      <p style={{ fontFamily: T.fontB, fontSize: 14, fontWeight: 570, lineHeight: 1.5, color: T.darkGrey, marginBottom: 48, textAlign: "center" }}>
        {vs.length} variants available — compare specs below
      </p>
      <div style={{ display: "grid", gridTemplateColumns: `repeat(${vs.length}, 1fr)`, gap: 0 }}>
        {vs.map((v, vi) => (
          <VariantCompareCard key={v.id} v={v} vi={vi} totalVariants={vs.length}
            onSelectVariant={onSelectVariant} onCompare={onCompare} isCompared={compared.includes(v.id)}
            diffKeys={diffKeys} sameKeys={sameKeys} getVal={getVal}
...
export default function App() {
  ...
  const [compareOrigin, setCompareOrigin] = useState(null);
  ...
  return (
    <div style={{ fontFamily: T.fontB, background: T.white, minHeight: "100vh" }}>
      ...
      {pg === "compare" && bike && <VariantComparePage bike={bike} onBack={handleCompareBack} backLabel={compareBackLabel} onSelectVariant={selVar} compared={comp} onCompare={toggleComp} variantPassesFilter={variantPassesFilter} />}
      {pg === "detail" && vari && <DetailPage variant={vari} family={bike?.family || vari.name} onBack={back} bike={bike} onCompareVariants={goToCompareFromDetail} variantPassesFilter={variantPassesFilter} />}
    </div>
  );
}
