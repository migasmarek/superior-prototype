...
function VariantCompareCard({ v, vi, totalVariants, onSelectVariant, onCompare, isCompared, diffKeys, sameKeys, getVal }) {
  const [h, setH] = useState(false);
...
function DetailPage({ variant, family, onBack }) {
  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 32px 64px" }}>
      <button onClick={onBack} style={{ display: "flex", alignItems: "center", gap: 6, background: "none", border: "none", cursor: "pointer", fontSize: 14, fontWeight: 570, color: T.darkGrey, padding: "28px 0 20px", fontFamily: T.fontB }}>← Back</button>
